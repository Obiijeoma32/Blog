...
function Inn() {
  return (
    <>
      {/* Large Screens */}
      <div className="flex w-full items-center justify-center mt-[0px]">
        <div className=" 13inch:flex 3xxS:hidden flex-col w-full justify-between  gap-[70px] items-start">
