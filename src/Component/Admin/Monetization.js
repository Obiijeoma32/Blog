  ...
  return (
    <>
      ...
      <div className=" pl-[320px] pt-[50px] pr-[30px] py-[10px]  flex-col w-full  ">
        <div className="text-sky-950 text-2xl font-normal font-['Montserrat'] leading-[28.80px]">Monetization</div>
        ...
        <div className="w-full  h-fit p-[24px] shadow border border-gray-200  mt-10 gap-[16px]  rounded-lg  flex-col justify-start items-start  inline-flex">
          <div className="grow shrink justify-start items-start  inline-flex basis-0 text-sky-950 text-lg font-semibold font-['Montserrat'] leading-relaxed">Top Performing AD Unit</div>
        </div>
      </div>
    </>
  );
